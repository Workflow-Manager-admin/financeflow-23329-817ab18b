...
const icons = {
  ...
  settings: (
    // Minimal, modern outlined gear SVG for Settings (matched style)
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <circle cx="12" cy="12" r="3" />
      <path d="M19.1 13.5c.04-.31.06-.63.06-.95s-.02-.64-.06-.95l1.34-1a.48.48 0 0 0 .11-.62l-1.26-2.2a.48.48 0 0 0-.6-.22l-1.58.64a7.24 7.24 0 0 0-1.64-.95l-.24-1.7A.48.48 0 0 0 14 3.5h-2.5a.48.48 0 0 0-.47.39l-.24 1.7c-.6.23-1.17.55-1.64.95l-1.58-.64a.48.48 0 0 0-.6.22l-1.26 2.2a.48.48 0 0 0 .11.62l1.34 1c-.04.31-.06.63-.06.95s.02.64.06.95l-1.34 1a.48.48 0 0 0-.11.62l1.26 2.2a.48.48 0 0 0 .6.22l1.58-.64c.47.39 1.04.7 1.64.95l.24 1.7c.05.23.24.39.47.39H14c.23 0 .42-.16.47-.39l.24-1.7c.6-.25 1.17-.56 1.64-.95l1.58.64a.48.48 0 0 0 .6-.22l1.26-2.2a.48.48 0 0 0-.11-.62l-1.34-1Z" />
    </svg>
  ),
};
